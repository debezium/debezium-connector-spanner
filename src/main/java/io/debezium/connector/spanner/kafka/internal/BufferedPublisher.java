...
/**
 * This class allows to publish the latest buffered value once per time period, except the case: if
 * the value is required to be published immediately.
 */
public class BufferedPublisher<V> {
    ...
    public BufferedPublisher(
                             ...
                             String name,
                             long timeout,
                             Predicate<V> publishImmediately,
